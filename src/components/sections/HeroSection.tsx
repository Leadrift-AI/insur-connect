        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-montserrat font-bold text-primary leading-tight animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                Free Your Agents From{" "}
                <span className="gradient-primary bg-clip-text text-transparent mx-0 animate-shimmer bg-[length:200%_100%]">
                  Busywork
                </span>
              </h1>
            ...
            {/* Stats */}
            <div className="flex flex-wrap gap-8 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style={{ animationDelay: '1s' }}>
              <Button 
                variant="hero" 
                size="xl" 
                className="group hover:shadow-elegant hover:-translate-y-0.5 transition-all duration-300" 
                onClick={() => navigate('/auth')}
                aria-label="Start your free trial of Leadrift AI"
              >
                Start Free Trial
              ...
              <Button 
                variant="outline" 
                size="xl" 
                className="group hover:shadow-card hover:-translate-y-0.5 transition-all duration-300"
                aria-label="Watch Leadrift AI demo video"
              >
            ...
            {/* Trust Indicators */}
            <div className="pt-8 border-t border-border animate-fade-in-up" style={{ animationDelay: '1.2s' }}>
          ...
          <div className="relative animate-slide-in-right" style={{ animationDelay: '0.5s' }}>
            <div className="relative rounded-2xl overflow-hidden shadow-elegant group">
              <img 
                src={heroImage} 
                alt="Insurance agent using Leadrift AI dashboard showing leads management interface" 
                className={`w-full h-auto object-cover transition-all duration-700 ${imageLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-105'}`}
            ...
            {/* Floating Cards */}
            <div className="absolute -top-4 -left-4 bg-white/95 backdrop-blur-sm rounded-lg shadow-card p-4 border border-border animate-fade-in hover:shadow-elegant hover:-translate-y-1 transition-all duration-300" style={{ animationDelay: '1.5s' }}>
            ...
            <div className="absolute -bottom-4 -right-4 bg-white/95 backdrop-blur-sm rounded-lg shadow-card p-4 border border-border animate-fade-in hover:shadow-elegant hover:-translate-y-1 transition-all duration-300" style={{ animationDelay: '1.7s' }}>
              <div className="flex items-center space-x-2">
